 ...
 * Reusable header for all user pages
 */

// Require authentication helper
require_once __DIR__ . '/../../config/auth.php';

// Require user role - will redirect if not authenticated or wrong role
requireAuth('user');
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>TheBigFive Payroll - User</title>
