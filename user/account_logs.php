...
.alert-danger-modern i { font-size: 20px; }
...
.filter-header h5 { margin: 0; font-size: 16px; font-weight: 600; color: #1e293b; }
.filter-header h5 i { color: #3b82f6; margin-right: 0.5rem; }
...
.form-group label { font-size: 13px; font-weight: 600; color: #475569; margin-bottom: 0.5rem; }
.form-group label i { color: #3b82f6; margin-right: 0.25rem; }
...
.btn-secondary-modern:hover { background: #e2e8f0; }
...
.logs-header h5 { margin: 0; font-size: 16px; font-weight: 600; color: #1e293b; }
.logs-header h5 i { color: #3b82f6; margin-right: 0.5rem; }
...
.logs-body { padding: 1.5rem; }

/* Empty State */
.empty-state { text-align: center; padding: 4rem 2rem; color: #64748b; }
.empty-state i { font-size: 64px; color: #cbd5e1; margin-bottom: 1rem; }
.empty-state h3 { font-size: 20px; font-weight: 600; color: #475569; margin: 0 0 0.5rem 0; }
...
.timeline-marker.badge-success { background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); color: #059669; }
.timeline-marker.badge-secondary { background: linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 100%); color: #64748b; }
.timeline-marker.badge-info { background: linear-gradient(135deg, #cffafe 0%, #a5f3fc 100%); color: #0891b2; }
.timeline-marker.badge-warning { background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); color: #d97706; }
.timeline-marker.badge-primary { background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); color: #2563eb; }
.timeline-marker.badge-danger { background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); color: #dc2626; }
...
.timeline-title { display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap; }
.timeline-title h4 { margin: 0; font-size: 15px; font-weight: 600; color: #1e293b; }
...
.badge-modern.badge-success { background: #d1fae5; color: #059669; }
.badge-modern.badge-secondary { background: #f1f5f9; color: #64748b; }
.badge-modern.badge-info { background: #cffafe; color: #0891b2; }
.badge-modern.badge-warning { background: #fef3c7; color: #d97706; }
.badge-modern.badge-primary { background: #dbeafe; color: #2563eb; }
.badge-modern.badge-danger { background: #fee2e2; color: #dc2626; }
...
.timeline-description { margin: 0 0 0.75rem 0; font-size: 14px; color: #475569; line-height: 1.6; }

.timeline-meta { display: flex; gap: 1.5rem; flex-wrap: wrap; }
.meta-item { font-size: 12px; color: #64748b; display: flex; align-items: center; gap: 0.375rem; }
.meta-item i { color: #94a3b8; }

/* Pagination */
.pagination-modern { margin-top: 2rem; }
.pagination { display: flex; justify-content: center; gap: 0.5rem; list-style: none; padding: 0; margin: 0; }
.page-item { margin: 0; }
