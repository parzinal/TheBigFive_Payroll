 ...
 * Display all employees with generated payslips (mirrors admin layout)
 */
...
.stat-value { font-size: 28px; font-weight: 700; color: #1e293b; line-height: 1; margin-bottom: 5px; }
...
.employee-info { display: flex; gap: 12px; align-items: flex-start; }
...
.employee-details { flex: 1; color: white; }
.employee-name { margin: 0 0 5px 0; font-size: 17px; font-weight: 600; color: white; }
.employee-code {
    display: inline-block; background: rgba(255,255,255,0.2);
    padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 500; margin-bottom: 8px;
}
.employee-meta { display: flex; flex-direction: column; gap: 5px; margin-top: 8px; }
.meta-item { display: flex; align-items: center; gap: 6px; font-size: 12px; opacity: 0.95; }
.meta-item i { width: 16px; text-align: center; }
.payslip-card-body { padding: 18px; }
.payslip-stats { display: flex; flex-direction: column; gap: 12px; }
.stat-item {
    display: flex; align-items: center; gap: 12px; padding: 12px;
    background: #f8fafc; border-radius: 8px; transition: all 0.2s ease;
}
...
.stat-number { font-size: 15px; font-weight: 700; color: #1e293b; line-height: 1.2; }
.stat-text { font-size: 11px; color: #64748b; font-weight: 500; }
.payslip-card-footer { padding: 0 18px 18px 18px; }
.btn-view-payslips {
...
.btn-view-payslips i { font-size: 14px; }
...
.no-payslips-message i { font-size: 64px; color: #cbd5e1; margin-bottom: 20px; }
.no-payslips-message h3 { font-size: 24px; color: #475569; margin: 0 0 12px 0; }
.no-payslips-message p { font-size: 15px; color: #64748b; margin: 0; }

/* Modal Styles */
.modal-payslips {
    display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0;
    background: rgba(0,0,0,0.75); z-index: 10000; overflow-y: auto; padding: 40px 20px;
}
.modal-payslips.active { display: flex; align-items: flex-start; justify-content: center; }
.modal-payslips-content {
    background: #f8fafc; border-radius: 16px; width: 100%; max-width: 900px;
...
.modal-payslips-header h2 { margin: 0; font-size: 24px; font-weight: 600; }
.modal-close {
...
.modal-payslips-body { padding: 32px; max-height: calc(100vh - 200px); overflow-y: auto; }

/* Cutoff Filter Bar */
.payslip-filter-bar {
    display: flex; align-items: center; gap: 12px; padding: 14px 18px;
    background: #f1f5f9; border-radius: 10px; margin-bottom: 20px; flex-wrap: wrap;
}
.payslip-filter-bar label { font-size: 13px; font-weight: 600; color: #475569; white-space: nowrap; }
.payslip-filter-bar select {
    padding: 8px 14px; border: 2px solid #e2e8f0; border-radius: 8px;
    font-size: 13px; color: #1e293b; background: #fff; cursor: pointer;
    transition: border-color 0.2s; min-width: 130px;
}
.payslip-filter-bar select:focus { outline: none; border-color: #2563EB; }
.payslip-filter-bar .filter-divider { width: 1px; height: 28px; background: #cbd5e1; }
.btn-filter-reset {
    padding: 8px 16px; background: #e2e8f0; color: #475569; border: none; border-radius: 8px;
    font-size: 13px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 6px;
    transition: all 0.2s; white-space: nowrap;
}
.btn-filter-reset:hover { background: #cbd5e1; color: #1e293b; }
.filter-result-count { margin-left: auto; font-size: 12px; color: #64748b; font-weight: 500; }
.payslip-list-item.hidden-by-filter { display: none; }
.no-filter-results { text-align: center; padding: 40px 20px; color: #94a3b8; font-size: 15px; }
.no-filter-results i { font-size: 36px; display: block; margin-bottom: 12px; color: #cbd5e1; }
.loading-spinner { text-align: center; padding: 60px 20px; color: #64748b; font-size: 18px; }
.loading-spinner i { font-size: 48px; margin-bottom: 16px; display: block; color: #2563EB; }

/* Payslip List Grid */
.payslip-list-grid { display: grid; gap: 16px; }
.payslip-list-item {
    background: white; border-radius: 12px; border: 2px solid #e2e8f0; padding: 20px;
    display: flex; justify-content: space-between; align-items: center; transition: all 0.3s ease;
}
.payslip-list-item:hover {
    border-color: #2563EB; box-shadow: 0 4px 12px rgba(37,99,235,0.15); transform: translateY(-2px);
}
.payslip-list-info { flex: 1; }
.payslip-list-period {
    font-size: 18px; font-weight: 600; color: #1e293b; margin: 0 0 8px 0;
...
.cutoff-badge.first { background: #dbeafe; color: #1d4ed8; border: 1.5px solid #93c5fd; }
.cutoff-badge.second { background: #fef3c7; color: #b45309; border: 1.5px solid #fcd34d; }
.payslip-list-meta { display: flex; gap: 20px; flex-wrap: wrap; }
.payslip-list-meta-item { font-size: 13px; color: #64748b; display: flex; align-items: center; gap: 6px; }
.payslip-list-meta-item i { color: #2563EB; }
.payslip-list-meta-item strong { color: #1e293b; font-weight: 600; }
.btn-view-payslip {
    padding: 12px 28px; background: linear-gradient(135deg, #2563EB 0%, #1d4ed8 100%);
    color: white; border: none; border-radius: 8px; font-size: 14px; font-weight: 600;
...
.btn-download-pdf {
    padding: 10px 20px; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%);
...
.btn-download-pdf:hover {
    ...
    transform: translateY(-2px); box-shadow: 0 6px 16px rgba(220,38,38,0.3);
    color: white; text-decoration: none;
}

/* Receipt Modal */
.modal-receipt {
    display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 10001; overflow-y: auto;
}
.modal-receipt.active { display: flex; align-items: center; justify-content: center; padding: 20px; }
.modal-receipt-overlay {
    position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.75); z-index: 1;
}
.modal-receipt-content {
    position: relative; z-index: 2; background: white; border-radius: 12px;
    box-shadow: 0 20px 60px rgba(0,0,0,0.3); max-width: 960px; width: 95vw; max-height: 90vh; overflow-y: auto;
}
.receipt-close-btn {
    ...
    z-index: 10; margin: 10px 10px 0 0; transition: all 0.2s ease;
}
.receipt-close-btn:hover { background: rgba(0,0,0,0.8); }

/* Responsive */
@media (max-width: 768px) {
    .employee-payslip-cards { grid-template-columns: 1fr; }
    .stats-row { grid-template-columns: 1fr; }
    .modal-payslips-content { margin: 0; border-radius: 0; min-height: 100vh; }
    .modal-payslips-header { border-radius: 0; }
    .modal-receipt-content { max-width: 100%; border-radius: 0; max-height: 100vh; }
    .payslip-list-item { flex-direction: column; align-items: flex-start; gap: 15px; }
    .btn-view-payslip { width: 100%; justify-content: center; }
    .payslip-list-meta { flex-direction: column; gap: 8px; }
}
</style>
...
function renderPayslipList(payslips, container) {
    ...
    payslips.forEach(payslip => {
        ...
        const ym = payslip.start_date ? payslip.start_date.substring(0, 7) : '';
        ...
        <div class="payslip-list-item" data-ym="${ym}" data-cutoff="${cutoffKey}">
            ...
            <div style="display:flex;gap:8px;flex-direction:column;align-items:stretch;min-width:140px;">
                ...
                <a class="btn-download-pdf" href="../admin/generate_payslip_pdf.php?payslip_id=${payslip.id}" target="_blank">
...
// Show single payslip in TB5 receipt format
...
function closePayslipsListModal() {
    document.getElementById('payslipsListModal').classList.remove('active');
}

function closePayslipReceiptModal() {
    document.getElementById('payslipReceiptModal').classList.remove('active');
}
...
document.addEventListener('click', function(event) {
    if (event.target === document.getElementById('payslipsListModal')) {
