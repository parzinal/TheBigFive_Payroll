 ...
 * Reusable header for all staff pages
 */

// Require authentication helper
require_once __DIR__ . '/../../config/auth.php';

// Require staff role - will redirect if not authenticated or wrong role
requireAuth('staff');

// Get user information
$user_name = isset($_SESSION['full_name']) ? $_SESSION['full_name'] : 'Staff';
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>TheBigFive Payroll - Staff</title>
