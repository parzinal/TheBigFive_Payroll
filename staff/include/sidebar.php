 ...
 * Reusable sidebar for all staff pages
 */
?>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-brand">
            ...
            <div class="brand-text">
                <span class="brand-title"><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Staff'); ?></span>
                <span class="brand-subtitle"><?php echo ucfirst($_SESSION['role'] ?? 'Staff'); ?></span>
            </div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            <li class="menu-item">
                <a href="dashboard_staff.php" class="menu-link">
...
(function() {
    ...
    menuLinks.forEach(link => {
        ...
        if (href && (href === currentPage || href.includes(currentPage))) {
            ...
            // If it's in a submenu, ensure the submenu is expanded (only when not collapsed)
